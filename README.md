...
This project is an object detection for autonomous vehicles using the Yolov5 deployed at the Jetson Nano. The framework used the Pytorch and training of the model will be done in Google Colab.  
